...
public class ModItems {
	...
	//Items
	public static Item THATCH_SACK = new ItemSack("thatch_sack", 1, GuiHandler.Type.SACK_THATCH);
	public static Item LEATHER_SACK = new ItemSack("leather_sack", 4, GuiHandler.Type.SACK_LEATHER);
