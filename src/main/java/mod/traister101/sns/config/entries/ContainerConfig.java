...
public final class ContainerConfig {
	...
	public static ContainerConfig build(final Builder builder, final String containerName, final boolean doPickup, final boolean doVoiding,
		...
		final ContainerConfig containerConfig = new ContainerConfig(
				...
				builder.comment("Determines if this container can transfer items in an inventory").define("doInventoryTransfer", doInventoryTransfer),
